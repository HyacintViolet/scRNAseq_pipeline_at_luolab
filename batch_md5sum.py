...
if __name__ == "__main__":
    ...
    # Input
    parent_dir = '/media/luolab/ZA1BT1ER/scRNAseq/yanting_all/data/yanting_191220/'
    filenames = fetch_qc_file_list(parent_dir)

    # Output
    out_dir = os.path.join(parent_dir, "md5sum.txt")

    number_of_processes = 32

    p = mp.Pool(number_of_processes)  # specify number of concurrent processes
    with open(out_dir, "wb") as logfile:
